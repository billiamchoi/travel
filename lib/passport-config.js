...
module.exports = function(passport) {
  ...
  passport.use('local-signin', new LocalStrategy({
    ...
    try {
      ...
      return done(null
        , false, req.flash('danger', 'Invalid email or password'));
    } catch(err) {
      done(err);
    }
  }));
  ...
  passport.use(new FacebookStrategy({
    ...
    clientID : '473403559976320',
    clientSecret : '5eb0f3d9d92ea2d8dfa589c14ef04c28',
    callbackURL : 'https://wooyoung-trip.herokuapp.com/auth/facebook/callback',
